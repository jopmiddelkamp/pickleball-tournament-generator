...
export const zh: Messages = {
  ...
  /** 公开的 /levels 页面：我们的六个等级对应通用的 1.0–5.5 评分。 */
  levelGuide: {
    heading: "等级说明",
    lede: "每位报名者都自报一个等级，排程器用它来平衡各个球场。匹克球通用 1.0–5.5 的评分尺度；我们把它归为六个等级，方便快速选择。",
    howToPick: "选一个符合你平常水平的等级，而不是你发挥最好的那天。在两个之间犹豫？选低的那个。有 DUPR 评分？参考每个等级旁边的区间。",
    rating: (range: string) => `评分 ${range}`,
    tiers: {
      1: {
        range: "1.0–2.0",
        summary: "刚接触这项运动。还在学习规则、发球和站位。",
        skills: [
          "回合很短，目标是把球打过网。",
          "发球和接发球不稳定。",
          "还不熟悉厨房区规则和报分方式。",
      ...
      2: {
        range: "2.5",
        summary: "了解规则，能用慢球维持短回合。",
        skills: [
          "发球和接发球大多能落在界内。",
          "主要在底线打球；第三拍吊球和网前小球还很陌生。",
          "了解双打站位的基本原则。",
        ],
      },
      3: {
        range: "3.0",
        summary: "能维持中等速度的回合，知道双打时该站在哪里。",
        skills: [
          "发球和接发球稳定，有一定深度。",
          "会上到厨房线，开始尝试小球和吊球，但还不够稳定。",
          "能截击容易的球；在压力下仍会出现非受迫性失误。",
        ],
      },
      4: {
        range: "3.5",
        summary: "在厨房线上比较自如：小球、吊球和截击有一定控制。",
        skills: [
          "有意识地使用第三拍吊球，并变换节奏。",
          "能维持小球对拉，等待可攻击的球。",
          "与搭档沟通，作为一个团队移动。",
      ...
      5: {
        range: "4.0",
        summary: "有耐心、有目的地掌控回合，非受迫性失误少。",
        skills: [
          "小球、吊球、抽球和化解球随心运用，带旋转和落点控制。",
          "读懂对手，惩罚高球，选择进攻时机。",
          "能防守快速对攻，挡住重抽。",
        ],
      },
      6: {
        range: "4.5 及以上",
        summary: "比赛级水平：压力下可靠，各项技术都很扎实。",
        skills: [
          "打的是战术而不只是分数：预判、布局、终结。",
          "能化解进攻，很少白送回合。",
          "根据对面的对手调整风格和节奏。",
        ],
      },
  ...
  organiser: {
    ...
    form: {
      ...
      minLevel: "最低等级",
      anyLevel: "不限等级",
      minLevelHint: "球员报名时自行选择等级。设定最低等级后，低于该等级的球员无法报名。",
      create: "创建活动",
  ...
  public: {
    ...
    notSure: "不确定",
    notSureHint: "选择一个等级即可报名。不知道选哪个？",
    levelsLink: "查看等级说明",
    minLevel: (level: string) => `本次活动面向 ${level} 及以上。`,
    errors: {
      invalid: "请输入姓名，并选择你的打法和级别。",
      level: "本次活动设有最低等级。请检查每位球员所选的等级。",
      closed: "报名已关闭。",
      full: "本场活动名额已满。",
