...
export const ko: Messages = {
  ...
  rules: {
    ...
    ranking: {
      title: "순위",
      body: "이 밤은 최고의 여자와 남자를 축하합니다. 전체·여자·남자 톱 3가 순위표 위에 표시됩니다. 합계가 높은 순입니다. 동점이면 득실차(우리 팀 득점 − 상대 득점)로 가리고, 그것도 같으면 같은 순위입니다.",
  ...
  standings: {
    ...
    top: { overall: "전체 톱 3", women: "여자 톱 3", men: "남자 톱 3" },
  },
