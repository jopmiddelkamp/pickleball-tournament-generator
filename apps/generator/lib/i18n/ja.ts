...
export const ja: Messages = {
  ...
  /** 公開ページ /levels：6段階のレベルを一般的な1.0〜5.5のレーティングに対応させたもの。 */
  levelGuide: {
    heading: "レベルの目安",
    lede: "参加登録には自己申告のレベルが付き、スケジューラーはそれを使ってコートのバランスを取ります。ピックルボールでは1.0〜5.5のレーティングが使われますが、選びやすいように6段階にまとめています。",
    howToPick: "調子が最高の日ではなく、いつもの夜の自分に合うレベルを選んでください。迷ったら低い方を。DUPRレーティングがあれば、各レベルの横の範囲を参考にしてください。",
    rating: (range: string) => `レーティング ${range}`,
    tiers: {
      1: {
        range: "1.0〜2.0",
        summary: "始めたばかり。ルール、サーブ、立ち位置をまだ覚えている段階。",
        skills: [
          "ラリーは短く、ボールをネットの向こうに返すのが目標。",
          "サーブとリターンが安定しない。",
          "キッチンのルールやスコアのコールにまだ慣れていない。",
        ],
      },
      2: {
        range: "2.5",
        summary: "ルールを理解し、遅いボールなら短いラリーを続けられる。",
        skills: [
          "サーブとリターンはだいたい入る。",
          "主にベースラインから打つ。サードショットドロップやディンクはまだ新しい。",
          "ダブルスの基本的なポジションを知っている。",
        ],
      },
      3: {
        range: "3.0",
        summary: "中くらいのペースのラリーを続けられ、ダブルスでどこにいるべきか分かる。",
        skills: [
          "サーブとリターンが安定し、ある程度の深さがある。",
          "キッチンラインまで前進し、ディンクやドロップを始めているが、まだ安定しない。",
          "簡単なボールはボレーできる。プレッシャーがかかるとまだミスが出る。",
        ],
      },
      4: {
        range: "3.5",
        summary: "キッチンラインで落ち着いてプレーできる。ディンク、ドロップ、ボレーにある程度のコントロールがある。",
        skills: [
          "サードショットドロップを意図的に使い、ペースに変化をつける。",
          "ディンクのラリーを続け、攻められるボールを待てる。",
          "パートナーと声を掛け合い、チームとして動く。",
        ],
      },
      5: {
        range: "4.0",
        summary: "忍耐と意図を持ってラリーを支配し、アンフォーストエラーが少ない。",
        skills: [
          "ディンク、ドロップ、ドライブ、リセットを自在に使い分け、スピンと配球がある。",
          "相手を読み、浮いたボールを叩き、攻めるタイミングを選ぶ。",
          "速い打ち合いを守り切り、強いドライブをブロックできる。",
        ],
      },
      6: {
        range: "4.5以上",
        summary: "大会レベル。プレッシャー下でも信頼でき、すべてのショットが強い。",
        skills: [
          "ポイントではなく戦略でプレーする：先読みし、組み立て、決める。",
          "攻撃をリセットし、ラリーをほとんど渡さない。",
          "ネットの向こうの相手に合わせてスタイルとペースを変える。",
        ],
      },
    },
  },
  ...
  roster: {
    heading: "今日のメンバーは？",
    lede: "レベルは登録時に本人が選んだ区分です。参加者リストと順位表には表示されますが、コートには出ません。",
    name: "名前",
  ...
  rules: {
    ...
    bye: {
      title: "休憩",
      body: "出番のないラウンドを「bye」と呼びます。順位表では「+n bye」と表示されます。休憩するラウンドは、そのラウンドにプレーした全員の平均点をもらえます。休憩で損をすることも、プレーより得をすることもありません。",
      example: "コートの得点が 11, 11, 5, 5, 11, 11, 9, 9 → 平均 9 なので、休憩した人は各 +9。",
    },
    ranking: {
      title: "順位",
      body: "この夜は最優秀の女性と男性を称えます。女性・男性それぞれのトップ3を順位表の上に表示します。合計点が高い順です。同点は得失点差（自分のチームの得点 − 相手の得点）で決め、それも同じなら同順位です。",
  ...
  standings: {
    heading: "順位",
    lede: "全員、自分のチームが取った点がそのまま得点になります。休憩はそのラウンドの平均点です。同点の場合は得失点差で順位を決め、合計の下に表示します。",
  ...
  organiser: {
    ...
    form: {
      ...
      minLevel: "最低レベル",
      anyLevel: "レベル不問",
      minLevelHint: "レベルはプレーヤーが登録時に自分で選びます。最低レベルを設定すると、それより下のレベルは登録できません。",
      create: "イベントを作成",
  ...
  public: {
    ...
    notSure: "わからない",
    notSureHint: "参加するにはレベルを選んでください。どれが合うかわからない？",
    levelsLink: "レベルの目安を見る",
    minLevel: (level: string) => `この夜は${level}以上が対象です。`,
    errors: {
      invalid: "名前を入力し、プレースタイルとレベルを選んでください。",
      level: "このイベントには最低レベルがあります。各プレーヤーのレベルを確認してください。",
      closed: "受付は終了しました。",
      full: "このイベントは満員です。",
